...
function Navbar() {
  ...
  return (
    <>
      <nav className="w-full fixed top-0 z-10 max-w-full h-[55px] p-5 mx-auto flex items-center justify-between container">
        <div onClick={() => router.push("/")} className="cursor-pointer">
          <Image src={Logo} alt="logo" className="w-[120px] h-[14px]" />
        </div>

        <div className="hidden xl:flex justify-center items-center text-gray-700">
          <button
            className="nav-link"
        ...
        <div className="hidden xl:flex  items-center justify-center text-gray-700">
        ...
        <div className="xl:hidden">
          <button
            onClick={handleNav}
            className="bg-black/10 hover:bg-black/20  font-semibold rounded-lg text-gray-700 text-sm transition ease-in duration-150 px-3 py-1"
          >
            Menu
          </button>
        </div>
