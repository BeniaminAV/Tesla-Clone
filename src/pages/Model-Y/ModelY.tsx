...
function ModelY() {
  ...
  const sectionStyle = {
    backgroundImage: `url("/Article/ModelY.jpg")`,
  };
      ...
      <div>
        ...
        >
          ...
          <div className="pt-[15vh] text-center">
            <h1 className="text-white text-4xl font-bold">Model Y</h1>
            ...
            <div className="flex text-white items-center justify-center w-full my-5">
              <Fade delay={100}>
                <div className="detail-show">
                  <h2 className="md:text-2xl text-md font-bold">76 cu ft</h2>
              ...
              <Fade delay={200}>
                <div className="detail-show">
                  <h2 className="md:text-2xl text-md font-bold">330 mi</h2>
                  <p className="md:text-sm text-[10px] font-bold">
                    Range(Epa est.)
                  </p>
                </div>
